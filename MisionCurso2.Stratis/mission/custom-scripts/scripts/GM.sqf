...
_ADF_GM_gear = {
	...
	removeUniform _u;
	removeHeadgear _u;
	_u forceAddUniform "CTS_WDL_Uniform_light2";
	_u addHeadgear "CTS_Beret";
	if (ADF_mod_TFAR) then {_u addBackpack "tf_rt1523g";} else {_u addBackpack "B_TacticalPack_blk";};
	_u addVest "CTS_WDL_Plate_Carrier_H";
	...
	if (ADF_Clan_uniformInsignia) then {[_u,"CTS"] call BIS_fnc_setUnitInsignia};
};
