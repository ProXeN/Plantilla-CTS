...
// Set in mission with: BRM_UNIFORMS_VDVCammo
// Valid values are "EMR", "FLORA" and "MFLORA"
_cammoPattern = "FLORA";

// Set in mission with: BRM_UNIFORMS_VDVMSV
// Use MSV uniforms.
_enableMSV = false;
...
// UNIFORMS ====================================================================
if(!isNil "BRM_UNIFORMS_VDVCammo")then{_cammoPattern=BRM_UNIFORMS_VDVCammo};
if(!isNil "BRM_UNIFORMS_VDVMSV")then{_enableMSV=BRM_UNIFORMS_VDVMSV};
