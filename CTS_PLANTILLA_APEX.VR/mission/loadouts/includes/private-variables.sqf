...
private [
    ...
    "_defaultSide","_factionSide","_commonRIFLE","_commonRIFLEGL","_commonPISTOL","_commonMG", "_factionName",
    ...
    "_isLeader","_bandage","_morphine","_epi","_bloodbag","_radio","_medkit","_wsmoke","_gsmoke","_rsmoke", "_bsmoke",
    "_backpack","_addBinocs","_addRadio","_addAmmo","_addWeapon","_wep","_ammoamount","_isMan",
    "_tourniquet", "_fieldDressing", "_packingBandage", "_elasticBandage","_quickClot", "_personalAidKit",
...
["Mando", "Alpha", "Bravo", "Charlie", "Delta", "Razor", "Foxtrot", "Titan", "Lancer", "Sierra", "Spartan"];
