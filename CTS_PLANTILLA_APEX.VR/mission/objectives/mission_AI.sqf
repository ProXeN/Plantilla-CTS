...
[{(mission_AI_controller)}, {
	...
	if ("dac_plugin" in usedPlugins) then { [{(!isNil "BRM_DAC_fnc_new") && (time > 5)}, {
		[trg1, "Create an activated normal default friendly zone named zone1 on network 1, with 1 group of infantry and 1 fire-team of vehicles."] spawn BRM_DAC_fnc_new;
