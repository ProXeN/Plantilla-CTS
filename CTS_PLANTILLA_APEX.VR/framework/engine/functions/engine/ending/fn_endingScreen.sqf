...
if (mission_enable_side_c) then {
    _thirdSideStats = format ["|| %1 bajas: %2", side_c_name, mission_dead_side_c];
};

// Formats a player's final score. =============================================

_personalScore = format ["PERSONAL SCORE: %1 muertes y %2 bajas. ", player getVariable ["unit_score",0], player getVariable ["unit_deaths",0]];
