...
Author: IndeedPete
Purpose: Wrapper function to create a simple conversation from several KB simple sentences (BRM_conversation_system_fnc_simpleSentenceKB).
----------
Parameters:
...
----------
Requires:
BRM_conversation_system_fnc_simpleSentence
...
for "_i" from 0 to ((count _sentences) - 1) do {
	...
	[_speaker, _receiver, _topic, _sentence, _whichChat, _bikb] call BRM_conversation_system_fnc_simpleSentenceKB;
