    ...
    case "create": {
        ...
        if ((_kind == "camp") || (_kind == "camps")) then {
            ...
            switch (_status) do {
                ...
                case "automatic": {
                    ...
                    _mynewMarker = ["local", _pos, "ELLIPSE", "Solid", _markerColor, [_ax, _ay], _aa, 0.5] call BRM_fnc_newMarkerArea;
        ...
        switch (true) do {
            case (_kind == "zone"): {
                ...
                [_name, _id, _status, _faction, _units select 0, _units select 1, _units select 2, _units select 3, _side, _skill, _area, _pos] call BRM_DAC_fnc_createDACZone;
            };
