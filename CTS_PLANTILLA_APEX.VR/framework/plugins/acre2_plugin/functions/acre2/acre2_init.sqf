...
f_acre2_presetSetup = compile preprocessFileLineNumbers "acre2_setupPresets.sqf";
f_acre2_clientInit = compile preprocessFileLineNumbers "acre2_clientInit.sqf";
f_fnc_GiveSideRadio = compile preprocessFileLineNumbers "fn_giveSideRadio.sqf";
