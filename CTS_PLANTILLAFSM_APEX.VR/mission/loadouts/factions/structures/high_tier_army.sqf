...
// =============================================================================
    ...
    case (_isSquadLeader): {
        ...
        [_unit,[[_gchemlight,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoUniform;
        [_unit, _commonPISTOL, _countPISTOL] call BRM_fnc_addWeaponKit;
    ...
    case (_isReconLeader): {
        ...
        [_unit, "BPR"] call BRM_fnc_addRadio;
        [_unit,[[_bsmoke,2],[_gsmoke,2],[_grenade,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoVest;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_fnc_addWeaponKit;
        [_unit, _commonTracer, _countTracerRIFLE] call BRM_fnc_addAmmo;
        [_unit, _commonPISTOL, _countPISTOL] call BRM_fnc_addWeaponKit;
    ...
    case (_isRifleman): {
        [_unit, _commonHEAD, _commonUNIFORM, _commonVEST, "empty"] call BRM_fnc_useUniform;
        [_unit,[[_wsmoke,5],[_gsmoke,2],[_grenade,_countGRENADES],[_gchemlight,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoVest;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_fnc_addWeaponKit;
        [_unit, "primary", _commonCCO] call BRM_fnc_attachToWeapon;
        [_unit, "primary", _commonLASER] call BRM_fnc_attachToWeapon;
        [_unit, _commonTracer, _countTracerRIFLE] call BRM_fnc_addAmmo;
    ...
    case (_isAutorifleman): {
        ...
        [_unit,[[_wsmoke,2],[_grenade,2],[_gchemlight,2],[_IRStrobe,1],[_CableTie,1],[_spareBarrel,1]]] call BRM_fnc_addtoVest;
    ...
    case (_isAutoriflemanAsst): {
        ...
        [_unit,[[_gchemlight,2],[_IRStrobe,1],[_CableTie,1],[_spareBarrel,1]]] call BRM_fnc_addtoBackpack;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_fnc_addWeaponKit;
        [_unit, "primary", _commonCCO] call BRM_fnc_attachToWeapon;
        [_unit, "primary", _commonLASER] call BRM_fnc_attachToWeapon;
    ...
    case (_isHeavyAT): {
        ...
        [_unit,[[_gchemlight,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoBackpack;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_fnc_addWeaponKit;
        [_unit, "primary", _commonCCO] call BRM_fnc_attachToWeapon;
        [_unit, "primary", _commonLASER] call BRM_fnc_attachToWeapon;
	   ...
	   case (_isATAssistant): {
        [_unit, _commonHEAD, _commonUNIFORM, _commonVEST, _bigBackpack] call BRM_fnc_useUniform;
        [_unit,[[_wsmoke,2],[_gsmoke,2],[_grenade,2],[(_commonRIFLE select 2),3],[_gchemlight,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoVest;
    ...
    case (_isAA): {
        [_unit, _commonHEAD, _commonUNIFORM, _commonVEST, _medBackpack] call BRM_fnc_useUniform;
        [_unit,[[_wsmoke,2],[_gsmoke,2],[_grenade,2]]] call BRM_fnc_addtoVest;
        [_unit, [[(_commonRIFLE select 2),3],[_gchemlight,2],[_IRStrobe,1],[_CableTie,1]]] call BRM_fnc_addtoBackpack;
        [_unit, _commonRIFLE, _countRIFLE] call BRM_fnc_addWeaponKit;
        [_unit, "primary", _commonCCO] call BRM_fnc_attachToWeapon;
        [_unit, "primary", _commonLASER] call BRM_fnc_attachToWeapon;
    ...
    case (_isHelicopterCrew): {
        ...
        [_unit,[[_wsmoke,2],[_gsmoke,2],[_gchemlight,2],[_IRStrobe,1],[_gFLARE,1]]] call BRM_fnc_addtoVest;
