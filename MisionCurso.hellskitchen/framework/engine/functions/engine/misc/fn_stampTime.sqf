...
private _i = -1;
["LOCAL", "LOG", format ["=== SERVER TIME STAMP @ %1: %2", time, _stamp apply { _i = _i + 1; format ["%1: %2", _names select _i, _x] } joinString " | "]] call BRM_fnc_doLog;

_stamp remoteExec ["BRM_fnc_syncTime", remoteExecutedOwner];
