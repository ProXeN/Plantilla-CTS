...
_commonRIFLE = _RHSM21A;
_commonRIFLEGL = _RHSM21AGL;
_commonPISTOL = _Glock;
_commonMG = _M249Minimi;
_commonMARKSMAN = _SVDM;
_commonSNIPER = _GM6;
_commonAT = _AT4;
_specAT = _PCML;
_commonSMG = _RHSM21S;
...
_headsLIST = [
    "FGN_AAF_PASGT_Type07_ESS",
    "FGN_AAF_PASGT_Type07_ESS_2",
    "FGN_AAF_PASGT_Type07"
];

_vestsLIST = [
  "FGN_AAF_CIRAS_Empty",
  "FGN_AAF_CIRAS_Engineer",
  "FGN_AAF_CIRAS_Engineer_CamB",
  "FGN_AAF_CIRAS_GL",
  "FGN_AAF_CIRAS_MG",
  "FGN_AAF_CIRAS_MM",
  "FGN_AAF_CIRAS_PSgt",
  "FGN_AAF_CIRAS_PSgt_CamB",
  "FGN_AAF_CIRAS_TL",
  "FGN_AAF_CIRAS_TL_CamB",
  "FGN_AAF_CIRAS_SL",
  "FGN_AAF_CIRAS_RF01",
  "FGN_AAF_CIRAS_RF01_Belt",
  "FGN_AAF_CIRAS_RF01_Belt_CamB",
  "FGN_AAF_CIRAS_RF01_CamB",
  "FGN_AAF_CIRAS_SAW",
  "FGN_AAF_CIRAS_SAW_Belt",
  "FGN_AAF_CIRAS_SAW_Belt_CamB",
  "FGN_AAF_CIRAS_SAW_CamB",
  "FGN_AAF_CIRAS_GL_Belt",
  "FGN_AAF_CIRAS_GL_Belt_CamB",
  "FGN_AAF_CIRAS_PSgt_Belt"
];

_uniformLIST = [
    "FGN_AAF_M10_Type07",
    "FGN_AAF_M10_Type07_Summer"
];
...
_officerUNIFORM = "FGN_AAF_M10_Type07_SSGT";
...
_medicVEST = "FGN_AAF_CIRAS_Medic",;
_demoVEST = _commonVEST;
_marksmanVEST = _commonVEST;
_reconVEST = _commonVEST;

_commonBACKPACK = "FGN_AAF_UMTBS_Type07";
_bigBACKPACK = "FGN_AAF_Bergen_Type07";
