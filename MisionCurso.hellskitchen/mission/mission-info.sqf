...
briefingName = "Operacion Pepiner";
onLoadName = "Operacion Pepiner";
author = "Proxen";
overviewPicture = "\cts_assets\overview\overview2.paa"; //1 Boosque, 2 Nocturno, 3 Tanoa, 4 Mediterraneo
overviewText = "Localizar contacto y recuperar informacion de un portatil.";
onLoadMission = "Operacion Pepiner";
