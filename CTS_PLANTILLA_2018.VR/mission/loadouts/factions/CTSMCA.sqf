...
_headsLIST = [
    "CTS_MCA_Helmet",
    "CTS_MCA_Helmet2",
    "CTS_MCA_Helmet_simple",
    "CTS_MCA_Helmet_simple2",
    "CTS_MCA_Helmet_light",
    "CTS_Mich2000_OGA",
    "CTS_Mich2000_CamoSprayTAN",
    "CTS_Mich2000_2_OGA",
    "CTS_Mich2000_2_CamoSprayTAN",
    "CTS_OGA_OPS",
    "CTS_Tan_Spray_OPS",
    "CTS_oga_OPS_2",
    "CTS_Tan_Spray_OPS_2",
...
_uniformsLIST = [
    ...
    "CTS_G2_camo_MCA_OD_Shirt",
    "CTS_G2_camo_rolled_MCA",
    "CTS_G2_camo_rolled_MCA_Tan_Shirt",
    "CTS_G2_camo_rolled_MCA_OD_Shirt",
    "CTS_ColdWeatherGear_camo_mca",
    "CTS_MCA_Uniform_tshirt"
];

_vestsLIST = [
    "CTS_MCA_Plate_Carrier",
    "CTS_MCA_Plate_Carrier_H",
...
_leaderHEAD = "Mohawk_Core_MANTA_tan";
...
_helicrewUNIFORM = "CTS_G2_camo_MCA";
...
_slVEST = _commonVEST;
_mgVEST = "CTS_CarrierRig_Gunner_OGA";
...
_commonBACKPACK = "CTS_MCA_Backpack_compact";
_bigBACKPACK = "CTS_MCA_Backpack_CarryAll";
_medBACKPACK = "CTS_MCA_Kitbag_compact";
