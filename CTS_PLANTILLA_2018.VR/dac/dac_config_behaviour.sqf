    ...
    // Default values you shouldn't worry about.
        ...
        _setFleeing = [0.4,400];
        _setHeliVal = [50,600,1,0];
        _setPause   = [[5,10],[5,10],[5,10],[20,30,5,5],[1,3],[1,30]];
    ...
    //-------------------------------------------------------------------------------------------------------------------------
        ...
        {
            //_setSkill = ["aimingAccuracy","aimingShake","aimingSpeed","Endurance","spotDistance","spotTime","courage","reloadSpeed","commanding","general"];
            _setSkill   = [mission_DAC_AI_skill, [0.5,0.7], [0.5,0.7], mission_DAC_AI_skill, mission_DAC_AI_skill, [0.6,0.7], [0.8,0.9], [0.2,0.4], mission_DAC_AI_skill, mission_DAC_AI_skill];
