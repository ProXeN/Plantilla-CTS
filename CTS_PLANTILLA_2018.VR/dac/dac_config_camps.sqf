...
// =============================================================================
    case 0: { // OPFOR CAMP
        ...
        _loadout = "auto";
        _campInfo = [EAST] call BRM_DAC_fnc_generateCampInfo;
...
// =============================================================================
    case 1: { // BLUFOR CAMP
        ...
        _loadout = "auto";
        _campInfo = [WEST] call BRM_DAC_fnc_generateCampInfo;
...
// =============================================================================
    case 2: { // INDFOR CAMP
        ...
        _loadout = "auto";
        _campInfo = [RESISTANCE] call BRM_DAC_fnc_generateCampInfo;
